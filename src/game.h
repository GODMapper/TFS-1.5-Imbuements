...
static constexpr int32_t MOVE_CREATURE_INTERVAL = 500;
static constexpr int32_t RANGE_MOVE_CREATURE_INTERVAL = 200;
static constexpr int32_t RANGE_MOVE_ITEM_INTERVAL = 200;
static constexpr int32_t RANGE_USE_ITEM_INTERVAL = 200;
static constexpr int32_t RANGE_USE_ITEM_EX_INTERVAL = 200;
static constexpr int32_t RANGE_USE_WITH_CREATURE_INTERVAL = 200;
static constexpr int32_t RANGE_ROTATE_ITEM_INTERVAL = 500;
static constexpr int32_t RANGE_BROWSE_FIELD_INTERVAL = 500;
static constexpr int32_t RANGE_WRAP_ITEM_INTERVAL = 500;
static constexpr int32_t RANGE_REQUEST_TRADE_INTERVAL = 500;
