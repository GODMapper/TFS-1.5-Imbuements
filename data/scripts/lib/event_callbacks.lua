...
EVENT_CALLBACK_ONIMBUE = 32
EVENT_CALLBACK_ONREMOVEIMBUE = 33

-- last (for correct table counting)
EVENT_CALLBACK_LAST = EVENT_CALLBACK_ONREMOVEIMBUE
...
local callbacks = {
	...
	-- Item
	["onImbue"] = EVENT_CALLBACK_ONIMBUE,
	["onRemoveImbue"] = EVENT_CALLBACK_ONREMOVEIMBUE
}
